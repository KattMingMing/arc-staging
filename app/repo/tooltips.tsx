...
export function isTooltipVisible(ctx: AbsoluteRepoFile, isBase: boolean): boolean {
    if (isBase) {
        return tooltip.classList.contains('tooltip-base') && tooltip.classList.contains(ctx.filePath) && tooltip.style.visibility === 'visible'
    }
    return !tooltip.classList.contains('tooltip-base') && tooltip.classList.contains(ctx.filePath) && tooltip.style.visibility === 'visible'
}
